...
if __name__ == "__main__":
    ...
    summary_template = """
        ...
        Format the result as json. Take care to encode special chars like quotes.
    """
    ...
    linkedin_profile_url = linkedin_lookup_agent.lookup(name="Eden Marco")
